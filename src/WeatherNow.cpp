...
// 配置请求信息，私钥、位置
void WeatherNow::config(String API_Host, String API_KEY, String Location_ID, String Unit, String Lang)
{
    _reqToken = API_KEY;
    _reqLocation = Location_ID;
    _reqHost = API_Host;
    _reqUnit = Unit;
    _reqLang = Lang;
}
...
// API状态码
String WeatherNow::getCode()
{
    return _response_code;
}

// 当前API最近更新时间
String WeatherNow::getObsTime()
{
